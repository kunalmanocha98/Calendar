...
public class GridAdapter extends ArrayAdapter {
    ...
    private List<EventskeObjects> allEvents;
    private int height;

    public GridAdapter(Context context, List<Date> monthlyDates, Calendar currentDate, List<EventskeObjects> allEvents, int height) {
